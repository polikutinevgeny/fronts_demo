...
class Dataset(keras.utils.Sequence):
    def __init__(self, filename, truth_filename):
        self.dates = None
        self.filename = filename
        self.varnames = ["air", "mslet", "shum", "uwnd", "vwnd"]
    ...
    def __len__(self):
        return int(math.ceil(len(self.dates) / self.batch_size))
